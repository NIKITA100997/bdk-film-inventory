...
на всё предприятие. Теперь один макет на kind: "roll"/"strip" —
единица плёнки, "cutting_issue" — печать сразу после резки/выдачи
участку, "rack_roll"/"rack_strip" — стеллаж целиком, "shelf" — отдельное
место хранения (раздел про отдельные макеты для рулонов/штрипсов/
стеллажей). kind уникален, id остаётся суррогатным ключом."""
