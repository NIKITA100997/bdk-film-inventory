/** Печатная форма отчёта (5 раздел обратной связи) — тот же приём, что и
 * для этикеток (fetchLabelHtml/printLabel): HTML-страница через браузер,
 * без PDF-библиотек. Печатает только те столбцы, что выбраны в конструкторе
