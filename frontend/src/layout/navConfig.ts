...
export const navTree: NavBlock[] = [
  {
    ...
    items: [
      ...
      // а не в "Материалах". Раздел про переработку вкладок остатков/
      // стеллажей — экран внутри уже объединён с картой стеллажей
      // (переключатель "Список/Карта", см. MaterialInventory.tsx), но оба
      // пункта меню намеренно оставлены (этот и "Стеллажи и полки" в
      // "Материалах" ниже) — экран живой, ежедневно используемый, менять
      // привычную навигацию задним числом рискованнее, чем оставить два
      // входа в один и тот же (уже объединённый) экран.
